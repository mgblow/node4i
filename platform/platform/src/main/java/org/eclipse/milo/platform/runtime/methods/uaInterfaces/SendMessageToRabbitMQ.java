...
public class SendMessageToRabbitMQ extends AbstractMethodInvocationHandler {
    ...
    public SendMessageToRabbitMQ(UaMethodNode node) {
        super(node);
    ...
    protected Variant[] invoke(InvocationContext invocationContext, Variant[] inputValues) throws UaException {
        try {
            ...
            UaInterface.getInstance(this.uaMethodNode.getNodeContext()).sendMessageToRabbitMQ(ioName,queueName,message);

...
public class EventDeleteMethod extends AbstractMethodInvocationHandler {
    ...
    public EventDeleteMethod(UaMethodNode uaMethodNode, AlarmEvent alarmEvent) {
        super(uaMethodNode);
    ...
    protected Variant[] invoke(InvocationContext invocationContext, Variant[] inputValues) throws UaException {
        ...
        try {
            ...
            this.alarmEvent.removeEvent(event);

...
class KeyStoreLoader {
    ...
    private static final String SERVER_ALIAS = "UA-PLATFORM";
    private static final char[] PASSWORD = "9780eff500abdc5305a1f77e81c33a82".toCharArray();
    ...
    KeyStoreLoader load(Path baseDir) throws Exception {
        ...
        File serverKeyStore = baseDir.resolve("ua-platform-server.pfx").toFile();
        ...
        if (!serverKeyStore.exists()) {
            ...
            String applicationUri = "urn:fanap:fanitoring:platform:server:" + UUID.randomUUID();

            SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
                    .setCommonName("UA Platform Server")
                    .setOrganization("Fanap")
                    .setOrganizationalUnit("Fanitoring")
                    .setLocalityName("Pardis")
                    .setStateName("TEH")
                    .setCountryCode("IR")

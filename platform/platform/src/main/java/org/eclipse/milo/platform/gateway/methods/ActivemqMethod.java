...
public class ActivemqMethod extends AmqpMethod {

    /**
     * @param uaMethodNode the {@link UaMethodNode} this handler will be installed on.
     */
    public ActivemqMethod(UaMethodNode uaMethodNode) {
        super(uaMethodNode);
    }

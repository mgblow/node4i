...
public class SendMessageToKafka extends AbstractMethodInvocationHandler {

    public static final Argument ioName = new Argument("ioName", Identifiers.String, ValueRanks.Any, null, new LocalizedText("ioName"));
    public static final Argument topic = new Argument("topic", Identifiers.String, ValueRanks.Any, null, new LocalizedText("namespaceIndex"));
    public static final Argument message = new Argument("message", Identifiers.String, ValueRanks.Any, null, new LocalizedText("identifier"));
    ...
    public SendMessageToKafka(UaMethodNode node) {
        super(node);
    ...
    public Argument[] getInputArguments() {
        return new Argument[]{ioName, topic, message};
    }
    ...
    protected Variant[] invoke(InvocationContext invocationContext, Variant[] inputValues) throws UaException {
        try {
            ...
            String topic = inputValues[1].getValue().toString();
            String message = inputValues[2].getValue().toString();
            UaInterface.getInstance(this.uaMethodNode.getNodeContext()).sendMessageToKafka(ioName, topic, message);
    ...
    protected void validateInputArgumentValues(Variant[] inputArgumentValues) throws InvalidArgumentException {
        MethodInputValidator.NotNull(this, ioName,topic,message);

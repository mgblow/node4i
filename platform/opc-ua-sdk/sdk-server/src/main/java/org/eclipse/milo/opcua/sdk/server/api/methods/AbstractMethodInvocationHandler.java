...
public abstract class AbstractMethodInvocationHandler implements MethodInvocationHandler {
    ...
    public final CallMethodResult invoke(AccessContext accessContext, CallMethodRequest request) {
        try {
            this.inputErrorMessages.clear();;
            checkExecutableAttributes(accessContext);

            this.inputArgumentValues = request.getInputArguments();
            ...
            return new CallMethodResult(
                ...
                new Variant[]{ new Variant(this.inputErrorMessages.toString())}
            );
        } catch (UaException e) {
    ...
    public Variant[] inputArgumentValues;
    public List<String> inputErrorMessages = new ArrayList<>();
    /**

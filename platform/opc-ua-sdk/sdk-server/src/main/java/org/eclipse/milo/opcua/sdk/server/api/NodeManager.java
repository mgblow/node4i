...
public interface NodeManager<T extends Node> {
     ...
     * Returns {@code false} if {@code nodeId} is non-local.
     *
     * @return the list of {@link Node}s identified by {@code nodeId} from this {@link NodeManager} or {@code null} if it does
     * not exist.
     */
     ...
     * @return the Node removed from this {@link NodeManager}, if it exists.
     */
    void removeNodeWithReferences(NodeId nodeId);

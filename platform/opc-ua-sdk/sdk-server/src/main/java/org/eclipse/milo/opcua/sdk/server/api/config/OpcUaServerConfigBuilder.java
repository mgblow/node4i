...
public class OpcUaServerConfigBuilder extends UaStackServerConfigBuilder {
    ...
    public OpcUaServerConfigBuilder setComponentsThreadPoolCount(int componentsThreadPoolCount) {
        super.setComponentsThreadPoolCount(componentsThreadPoolCount);
        return this;
    }
    @Override
    public OpcUaServerConfigBuilder setRedisUri(String redisUri) {
        super.setRedisUri(redisUri);
        return this;
    }
    ...
    public static final class OpcUaServerConfigImpl implements OpcUaServerConfig {
        ...
        public String getRedisUri() {
            return stackServerConfig.getRedisUri();
        }
        ...
        public Integer getComponentsThreadPoolCount() {
            return stackServerConfig.getComponentsThreadPoolCount();
        }
